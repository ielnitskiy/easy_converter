...
class AllCurrenciesList {
  ...
  static final allCurrenciesList = <String, Currency>{
    "AED": Currency(code: "AED", flag: Svgs.unitedArabEmirates, symbol: 'Dh', title: 'Дирхам ОАЭ', country: 'ОАЭ'),
    ...
    "BND": Currency(code: "BND",flag: Svgs.brunei, symbol: '\$', title: 'Брунейский доллар', country: 'Бруней'),
    ...
    "COP": Currency(code: "COP",flag: Svgs.colombia , symbol: '\$', title: 'Колумбийское песо', country: 'Колумбия'),
    ...
    "GHS": Currency(code: "GHS",flag: Svgs.ghana  , symbol: '₵', title: 'Ганский седи', country: 'Гана'),
    ...
    "GYD": Currency(code: "GYD",flag: Svgs.guyana  , symbol: '\$', title: 'Гайанский доллар', country: 'Гайана'),
    "HKD": Currency(code: "HKD",flag: Svgs.hongKong  , symbol: '\$', title: 'Гонконгский доллар', country: 'Гонконг'),
    ...
    "IQD": Currency(code: "IQD",flag: Svgs.iraq , symbol: 'Id', title: 'Иракский динар', country: 'Ирак'),
    "IRR": Currency(code: "IRR",flag: Svgs.iran , symbol: 'Ie', title: 'Иранский риал', country: 'Иран'),
    ...
    "MOP": Currency(code: "MOP",flag: Svgs.macao, symbol: '\$', title: 'Патака', country: 'Макао'),
    ...
    "OMR": Currency(code: "OMR",flag: Svgs.oman, symbol: 'Ro', title: 'Оманский риал', country: 'Оман'),
    ...
    "TND": Currency(code: "TND",flag: Svgs.tunisia , symbol: 'Dt', title: 'Тунисский динар', country: 'Тунис'),
    ...
    "TZS": Currency(code: "TZS",flag: Svgs.tanzania , symbol: 'Sh', title: 'Танзанийский шиллинг', country: 'Танзания'),
    "UAH": Currency(code: "UAH",flag: Svgs.ukraine , symbol: '₴', title: 'Гривна', country: 'Украина'),
    "UGX": Currency(code: "UGX",flag: Svgs.uganda , symbol: 'Sh', title: 'Угандийский шиллинг', country: 'Уганда'),
    ...
    "UZS": Currency(code: "UZS",flag: Svgs.uzbekistan , symbol: 'So', title: 'Узбекский сум', country: 'Узбекистан'),
