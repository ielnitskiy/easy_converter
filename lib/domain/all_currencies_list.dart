...
class AllCurrenciesList {
  ...
  static final allCurrenciesList = <String, Currency>{
    "AED": Currency(code: "AED", symbol: '', title: 'Дирхам ОАЭ	', country: 'ОАЭ'),
    "AFN": Currency(code: "AFN", symbol: '؋',  title: 'Афгани	', country: 'Афганистан'),
    "ALL": Currency(code: "ALL", symbol: 'L',  title: 'Лек', country: 'Албания'),
    "AMD": Currency(code: "AMD", symbol: '֏', title: 'Армянский драм', country: 'Армения'),
    "ANG":
        Currency(code: "ANG", symbol: 'ƒ',  title: 'Нидерландскийантильский гульден', country: 'Синт-Мартен'),
    "AOA": Currency(code: "AOA", symbol: 'Kz',  title: 'Кванза', country: 'Ангола'),
    "ARS": Currency(code: "ARS", symbol: '',  title: 'Аргентинское песо', country: 'Аргентина'),
    "AUD": Currency(code: "AUD", symbol: '\$',  title: 'Австралийский доллар', country: 'Австралия'),
    "AWG": Currency(code: "AWG", symbol: 'ƒ',  title: 'Арубанский флорин', country: 'Аруба'),
    "AZN": Currency(code: "AZN", symbol: '₼',  title: 'Азербайджанский манат', country: 'Азербайджан'),
    "BAM":
        Currency(code: "BAM", symbol: 'KM',  title: 'Конвертируемая марка', country: 'Босния и Герцеговина'),
    "BBD": Currency(code: "BBD", symbol: '\$',  title: 'Барбадосский доллар', country: 'Барбадос'),
    "BDT": Currency(code: "BDT", symbol: '৳',  title: 'Така', country: 'Бангладеш'),
    "BGN": Currency(code: "BGN", symbol: '',  title: 'Болгарский лев', country: 'Болгария'),
    ...
    "DOP":
        Currency(code: "DOP", symbol: '',  title: 'Доминиканское песо', country: 'Доминиканская Республика'),
    ...
    "FKP": Currency(
        code: "FKP", symbol: '',  title: 'ФунтФолклендских островов', country: 'Фолклендские острова'),
    ...
    "SBD": Currency(
        code: "SBD", symbol: '',  title: 'Доллар Соломоновых Островов', country: 'Соломоновы Острова'),
    ...
    "TTD":
        Currency(code: "TTD", symbol: '',  title: 'Доллар Тринидада и Тобаго', country: 'Тринидад и Тобаго'),
    "TWD":
        Currency(code: "TWD", symbol: '',  title: 'Новый тайваньский доллар', country: 'Китайская Республика'),
